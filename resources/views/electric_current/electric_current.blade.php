        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-hover">
                    ...
                    <tbody>
                    @foreach($electric_current as $work)
                    <tr>
                        <td>{{$work->id}}</td>
                        ...
                        <td class="col-2">
                            <form action="{{route('electric_current.destroy',$work->id)}}" method="POST">
                                ...
                                <a href="{{route('electric_current.destroy',$work->id)}}">
                                    @csrf
                                    @method('DELETE')
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        ...
                        @if ($electric_current->links())
                        <div class="mt-4 p-4 box has-text-centered">
                            {{ $electric_current->links() }}
                        </div>
                        @endif
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Elektr toki </h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{route('electric_current.store')}}" method="post">
                    @csrf
                    <div class="card-body">
...
<div class="modal fade" id="modal-default2">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('electric_current.update',1)}}" method="post">
